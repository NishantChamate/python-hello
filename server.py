...
# Manually specify the Firebase credentials file and database URL
FIREBASE_CREDENTIALS_FILE = "aprnrfbtst-firebase-adminsdk-fbsvc-8a69003d05.json"  # Replace with actual file path
FIREBASE_DATABASE_URL = "https://aprnrfbtst-default-rtdb.asia-southeast1.firebasedatabase.app/"  # Replace with your database URL
